...
genai.configure(api_key='AIzaSyDwPquxtT6lVYl1TFkWumeWHzNpHx6hoYI')
...
def generate_chat_name(query: str) -> str:
    ...
    try:
        ...
        prompt = f"Give a single title name for provided Query: {query}. No heading just single title."
